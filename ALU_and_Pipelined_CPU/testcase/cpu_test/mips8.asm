addi $t1, $zero, 12# To test the data hazard of beq and bne
addi $t2, $zero, -2
addi $t3, $zero, 23
addi $v0, $zero, 0
addi $v1, $zero, 19
...
sw $t0, 8($zero)  # if the branch is handled correctly,$t0 shoule be -2, and the value is stored in DATA_MEM[2]
addi $a2, $zero, 1 # meaningless instruction, just to avoid other hazards
