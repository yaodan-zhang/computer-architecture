...
addi $a0, $zero, -2 # $a0 shoule be -2# j makes pc moves to here
...
addi $t0, $zero, -16 # $t0 shoule be -16# jr makes pc moves to here
addi $t1, $zero, -32 # $t1 should be -32
addi $t2, $zero, -64 # $t2 should be -64
jal 32
addi $t3, $zero, 128  # $t3 shoule be 128 #jr jumps back to here
...
sw $a0, 0($zero)  # -2 in DATA_MEM[0] # j jumps to here
