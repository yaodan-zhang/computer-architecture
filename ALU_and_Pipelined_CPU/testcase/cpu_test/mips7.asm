addi $v0, $zero, 72# To test the data hazard about jr
addi $k0, $zero, 104
addi $s0, $zero, -1
addi $s1, $zero, -2
addi $s2, $zero, -4
...
addi $a0, $zero, 2 # $a0 shoule be 2# first jr jumps to here
...
addi $t0, $zero, 16 # $t0 shoule be 16# second jr jumps to here
